...
class _dapros_statistics_regional extends Model
{
    /**
    ...
    protected $fillable = [
        ...
        , 'call_input_k_kontak', 'call_input_pstn', 'call_input_dial_to', 'call_input_nama_pelanggan', 'call_regional', 'call_witel', 'call_paket', 'call_alamat_pemasangan', 'call_email', 'call_via_by'
    ];
    /**
    ...
    {
        return $this->belongsTo('App\_dapros_regional', 'dapros_id');
    }
