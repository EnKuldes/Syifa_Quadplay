                ...
                <legend>Cust Interaction</legend>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control @error('input_nama_pelanggan') is-invalid @enderror" placeholder="Nama Pelanggan"
                                  id="input_nama_pelanggan" name="input_nama_pelanggan" autocomplete="off">
	        ...
	        $.ajax({
		       ...
		       success: function(data){
		       	if (data['message'] != null && data['message'] != '') {
			       	...
			       	var valueTitles = ['pots','witel_information','nama_customer','klasifikasi_revenue','prioritas_1','prioritas_2','prioritas_3'];
			       	var labelTitles = ['pots','witel_information','nama_customer','klasifikasi_revenue','prioritas_1','prioritas_2','prioritas_3'];
	...
	function activity() {
        ...
        $.ajax({
	       ...
	       success: function(data){
	        ...
	        var spanTitles = ['unconsumed_daily', 'consumed_daily', 'c_daily', 'agree_daily', 'fu_daily', 'decline_daily', 'nc_daily', 'ncl_daily', 'approved_daily', 'return_daily', 'returntoagree_daily', 'returntodecline_daily'];
	        var valueTitles = ['unconsumed_daily', 'consumed_daily', 'c_daily', 'agree_daily', 'fu_daily', 'decline_daily', 'nc_daily', 'ncl_daily', 'approved_daily', 'return_daily', 'returntoagree_daily', 'returntodecline_daily'];;
