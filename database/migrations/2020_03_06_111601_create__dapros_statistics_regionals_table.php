...
class CreateDaprosStatisticsRegionalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('_dapros_statistics_regionals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('_dapros_statistics_regionals');
    }
}
